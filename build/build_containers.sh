git clone -b master https://github.com/camicroscope/DataDockerContainer.git; 
cd DataDockerContainer; git checkout tags/1.0; cd ..
git clone -b master https://github.com/camicroscope/LoaderDockerContainer.git;
cd LoaderDockerContainer; git checkout tags/1.0; cd ..
git clone -b master https://github.com/camicroscope/ViewerDockerContainer.git;
cd ViewerDockerContainer; git checkout tags/1.0; cd ..
git clone -b master https://github.com/camicroscope/OrderingService.git;
cd OrderingService; git checkout tags/1.0; cd ..
git clone -b master https://github.com/camicroscope/DynamicServices.git;
cd DynamicServices; git checkout tags/1.0; cd ..
git clone -b master https://github.com/SBU-BMI/findapi.git;
cd findapi; git checkout tags/1.0; cd ..
git clone -b master https://github.com/SBU-BMI/quip_cwl.git
